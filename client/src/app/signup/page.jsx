...
import { signup, googleSignIn } from "../../services/Auth/auth";
            ...
            <div className="w-full max-w-md">
                ...
                >
                    ...
                    <p className="mt-6 text-center font-mono text-xs text-black/50">
                        ...
                        <a href="/signin" className="font-bold text-black underline underline-offset-2">
                            Sign in
                        </a>
                    </p>
                </form>

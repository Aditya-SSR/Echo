        ...
        <main className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
            ...
            >
                ...
                <button
                    ...
                    className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white py-3 font-medium text-gray-700 transition hover:bg-gray-50 active:bg-gray-100"
                >
